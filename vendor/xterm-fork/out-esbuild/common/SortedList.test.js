 ...
 * @license MIT
 */
const deepStrictEqual = import_chai.assert.deepStrictEqual;
describe("SortedList", () => {
  let list;
  function assertList(expected) {
    deepStrictEqual(Array.from(list.values()), expected);
  }
  beforeEach(() => {
    list = new import_SortedList.SortedList((e) => e);
  });
  describe("insert", () => {
  ...
  it("custom key", () => {
    const customList = new import_SortedList.SortedList((e) => e.key);
