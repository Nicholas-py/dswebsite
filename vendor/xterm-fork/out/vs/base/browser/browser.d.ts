...
export declare const onDidChangeZoomLevel: import("vs/base/common/event").Event<number>;
...
export declare const onDidChangeFullscreen: import("vs/base/common/event").Event<number>;
