...
let Linkifier = class Linkifier extends lifecycle_1.Disposable {
    ...
    constructor(_element, _mouseService, _renderService, _bufferService, _linkProviderService) {
        ...
        this._activeLine = -1;
        this._onShowLinkUnderline = this._register(new event_1.Emitter());
        this.onShowLinkUnderline = this._onShowLinkUnderline.event;
        this._onHideLinkUnderline = this._register(new event_1.Emitter());
        this.onHideLinkUnderline = this._onHideLinkUnderline.event;
        this._register((0, lifecycle_1.toDisposable)(() => {
            (0, lifecycle_1.dispose)(this._linkCacheDisposables);
        ...
        this._register((0, dom_1.addDisposableListener)(this._element, 'mouseleave', () => {
            this._isMouseOut = true;
            this._clearCurrentLink();
        }));
        this._register((0, dom_1.addDisposableListener)(this._element, 'mousemove', this._handleMouseMove.bind(this)));
        this._register((0, dom_1.addDisposableListener)(this._element, 'mousedown', this._handleMouseDown.bind(this)));
        this._register((0, dom_1.addDisposableListener)(this._element, 'mouseup', this._handleMouseUp.bind(this)));
    }
