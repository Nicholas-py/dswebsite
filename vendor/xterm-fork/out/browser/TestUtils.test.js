...
const CoreBrowserTerminal_1 = require("browser/CoreBrowserTerminal");
...
class TestTerminal extends CoreBrowserTerminal_1.CoreBrowserTerminal {
...
class MockViewport {
    constructor() {
        this._onRequestScrollLines = new event_1.Emitter();
...
class MockCoreBrowserService {
    constructor() {
        this.onDprChange = new event_1.Emitter().event;
        this.onWindowChange = new event_1.Emitter().event;
        this.isFocused = true;
        this.dpr = 1;
    }
    get window() {
...
class MockCharSizeService {
    ...
    constructor(width, height) {
        this.width = width;
        this.height = height;
        this.onCharSizeChange = new event_1.Emitter().event;
    }
    measure() { }
}
...
class MockRenderService {
    constructor() {
        this.onDimensionsChange = new event_1.Emitter().event;
        this.onRenderedViewportChange = new event_1.Emitter().event;
        this.onRender = new event_1.Emitter().event;
        this.onRefreshRequest = new event_1.Emitter().event;
...
class MockSelectionService {
    constructor() {
        ...
        this.onLinuxMouseSelection = new event_1.Emitter().event;
        this.onRequestRedraw = new event_1.Emitter().event;
        this.onRequestScrollLines = new event_1.Emitter().event;
        this.onSelectionChange = new event_1.Emitter().event;
    }
    disable() {
        throw new Error('Method not implemented.');
    }
...
class MockThemeService {
    constructor() {
        this.onChangeColors = new event_1.Emitter().event;
        this.colors = {
            ...
            selectionBackgroundOpaque: Color_1.css.toColor('#ff0000'),
            selectionInactiveBackgroundOpaque: Color_1.css.toColor('#00ff00')
        };
    }
    restoreColor(slot) {
        throw new Error('Method not implemented.');
