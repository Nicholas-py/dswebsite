...
export declare class RenderService extends Disposable implements IRenderService {
    ...
    readonly onDimensionsChange: import("vs/base/common/event").Event<IRenderDimensions>;
    private readonly _onRenderedViewportChange;
    readonly onRenderedViewportChange: import("vs/base/common/event").Event<{
        start: number;
        end: number;
    }>;
    private readonly _onRender;
    readonly onRender: import("vs/base/common/event").Event<{
        start: number;
        end: number;
    }>;
    private readonly _onRefreshRequest;
    readonly onRefreshRequest: import("vs/base/common/event").Event<{
        start: number;
        end: number;
    }>;
