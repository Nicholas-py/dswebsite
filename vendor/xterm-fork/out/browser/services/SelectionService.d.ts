...
export declare class SelectionService extends Disposable implements ISelectionService {
    ...
    readonly onLinuxMouseSelection: import("vs/base/common/event").Event<string>;
    private readonly _onRedrawRequest;
    readonly onRequestRedraw: import("vs/base/common/event").Event<ISelectionRedrawRequestEvent>;
    private readonly _onSelectionChange;
    readonly onSelectionChange: import("vs/base/common/event").Event<void>;
    private readonly _onRequestScrollLines;
    readonly onRequestScrollLines: import("vs/base/common/event").Event<ISelectionRequestScrollLinesEvent>;
