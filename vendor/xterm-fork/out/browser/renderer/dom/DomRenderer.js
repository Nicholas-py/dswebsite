...
let DomRenderer = class DomRenderer extends lifecycle_1.Disposable {
    constructor(_terminal, _document, _element, _screenElement, _viewportElement, _helperContainer, _linkifier2, instantiationService, _charSizeService, _optionsService, _bufferService, _coreService, _coreBrowserService, _themeService) {
        ...
        this.onRequestRedraw = this._register(new event_1.Emitter()).event;
...
exports.DomRenderer = DomRenderer = __decorate([
    ...
    __param(11, Services_2.ICoreService),
    __param(12, Services_1.ICoreBrowserService),
    __param(13, Services_1.IThemeService)
], DomRenderer);
