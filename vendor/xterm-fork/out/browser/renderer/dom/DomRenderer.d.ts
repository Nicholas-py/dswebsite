...
export declare class DomRenderer extends Disposable implements IRenderer {
    ...
    readonly onRequestRedraw: import("vs/base/common/event").Event<IRequestRedrawEvent>;
    constructor(_terminal: ITerminal, _document: Document, _element: HTMLElement, _screenElement: HTMLElement, _viewportElement: HTMLElement, _helperContainer: HTMLElement, _linkifier2: ILinkifier2, instantiationService: IInstantiationService, _charSizeService: ICharSizeService, _optionsService: IOptionsService, _bufferService: IBufferService, _coreService: ICoreService, _coreBrowserService: ICoreBrowserService, _themeService: IThemeService);
