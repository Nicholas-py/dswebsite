...
export declare class TextureAtlas implements ITextureAtlas {
    ...
    readonly onAddTextureAtlasCanvas: import("vs/base/common/event").Event<HTMLCanvasElement>;
    private readonly _onRemoveTextureAtlasCanvas;
    readonly onRemoveTextureAtlasCanvas: import("vs/base/common/event").Event<HTMLCanvasElement>;
