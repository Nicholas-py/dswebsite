...
function generateConfig(deviceCellWidth, deviceCellHeight, deviceCharWidth, deviceCharHeight, options, colors, devicePixelRatio) {
    const clonedColors = {
        ...
        overviewRulerBorder: Color_1.NULL_COLOR,
        scrollbarSliderBackground: Color_1.NULL_COLOR,
        scrollbarSliderHoverBackground: Color_1.NULL_COLOR,
        scrollbarSliderActiveBackground: Color_1.NULL_COLOR,
