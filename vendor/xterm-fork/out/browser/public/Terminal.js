...
let $value = 0;
class Terminal extends lifecycle_1.Disposable {
    constructor(options) {
        super();
        this._core = this._register(new CoreBrowserTerminal_1.CoreBrowserTerminal(options));
        this._addonManager = this._register(new AddonManager_1.AddonManager());
    ...
    get buffer() {
        if (!this._buffer) {
            this._buffer = this._register(new BufferNamespaceApi_1.BufferNamespaceApi(this._core));
        }
        return this._buffer;
    }
    get markers() {
    ...
    static get strings() {
        return {
            get promptLabel() { return Strings.promptLabel.get(); },
            set promptLabel(value) { Strings.promptLabel.set(value); },
            get tooMuchOutput() { return Strings.tooMuchOutput.get(); },
            set tooMuchOutput(value) { Strings.tooMuchOutput.set(value); }
        };
    }
