...
export declare class Linkifier extends Disposable implements ILinkifier2 {
    ...
    readonly onShowLinkUnderline: import("vs/base/common/event").Event<ILinkifierEvent>;
    private readonly _onHideLinkUnderline;
    readonly onHideLinkUnderline: import("vs/base/common/event").Event<ILinkifierEvent>;
