...
const DEBUG = false;
let AccessibilityManager = class AccessibilityManager extends lifecycle_1.Disposable {
    constructor(_terminal, instantiationService, _coreBrowserService, _renderService) {
        ...
        this._liveRegionDebouncer = this._register(new TimeBasedDebouncer_1.TimeBasedDebouncer(this._renderRows.bind(this)));
        ...
        this._register((0, dom_1.addDisposableListener)(doc, 'selectionchange', () => this._handleSelectionChange()));
