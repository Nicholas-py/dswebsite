import { IInputHandler, IAttributeData, IDisposable, IColorEvent, ColorIndex } from 'common/Types';
...
export declare class InputHandler extends Disposable implements IInputHandler {
    ...
    readonly onRequestBell: import("vs/base/common/event").Event<void>;
    private readonly _onRequestRefreshRows;
    readonly onRequestRefreshRows: import("vs/base/common/event").Event<{
        start: number;
        end: number;
    } | undefined>;
    private readonly _onRequestReset;
    readonly onRequestReset: import("vs/base/common/event").Event<void>;
    private readonly _onRequestSendFocus;
    readonly onRequestSendFocus: import("vs/base/common/event").Event<void>;
    private readonly _onRequestSyncScrollBar;
    readonly onRequestSyncScrollBar: import("vs/base/common/event").Event<void>;
    private readonly _onRequestWindowsOptionsReport;
    readonly onRequestWindowsOptionsReport: import("vs/base/common/event").Event<WindowsOptionsReportType>;
    private readonly _onA11yChar;
    readonly onA11yChar: import("vs/base/common/event").Event<string>;
    private readonly _onA11yTab;
    readonly onA11yTab: import("vs/base/common/event").Event<number>;
    private readonly _onCursorMove;
    readonly onCursorMove: import("vs/base/common/event").Event<void>;
    private readonly _onLineFeed;
    readonly onLineFeed: import("vs/base/common/event").Event<void>;
    private readonly _onScroll;
    readonly onScroll: import("vs/base/common/event").Event<number>;
    private readonly _onTitleChange;
    readonly onTitleChange: import("vs/base/common/event").Event<string>;
    private readonly _onColor;
    readonly onColor: import("vs/base/common/event").Event<IColorEvent>;
    private _parseStack;
...
export declare function isValidColorIndex(value: number): value is ColorIndex;
