...
describe('InputHandler', () => {
    ...
    beforeEach(() => {
        ...
        inputHandler = new TestInputHandler(bufferService, new TestUtils_test_1.MockCharsetService(), coreService, new TestUtils_test_1.MockLogService(), optionsService, oscLinkService, new TestUtils_test_1.MockCoreMouseService(), new TestUtils_test_1.MockUnicodeService());
    });
    ...
    describe('setCursorStyle', () => {
        it('should call Terminal.setOption with correct params', () => {
            ...
            chai_1.assert.equal(coreService.decPrivateModes.cursorStyle, undefined);
            chai_1.assert.equal(coreService.decPrivateModes.cursorBlink, undefined);
            ...
            chai_1.assert.equal(coreService.decPrivateModes.cursorStyle, 'block');
            chai_1.assert.equal(coreService.decPrivateModes.cursorBlink, true);
            optionsService.options = (0, Clone_1.clone)(OptionsService_1.DEFAULT_OPTIONS);
            inputHandler.setCursorStyle(Params_1.Params.fromArray([2]));
            chai_1.assert.equal(coreService.decPrivateModes.cursorStyle, 'block');
            chai_1.assert.equal(coreService.decPrivateModes.cursorBlink, false);
            optionsService.options = (0, Clone_1.clone)(OptionsService_1.DEFAULT_OPTIONS);
            inputHandler.setCursorStyle(Params_1.Params.fromArray([3]));
            chai_1.assert.equal(coreService.decPrivateModes.cursorStyle, 'underline');
            chai_1.assert.equal(coreService.decPrivateModes.cursorBlink, true);
            optionsService.options = (0, Clone_1.clone)(OptionsService_1.DEFAULT_OPTIONS);
            ...
            chai_1.assert.equal(coreService.decPrivateModes.cursorStyle, 'bar');
            chai_1.assert.equal(coreService.decPrivateModes.cursorBlink, true);
            optionsService.options = (0, Clone_1.clone)(OptionsService_1.DEFAULT_OPTIONS);
    ...
    describe('OSC', () => {
        ...
        it('8: hyperlink with id', async () => {
            ...
            chai_1.assert.notStrictEqual(inputHandler.curAttrData.extended.urlId, 0);
            chai_1.assert.deepStrictEqual(oscLinkService.getLinkData(inputHandler.curAttrData.extended.urlId), {
                id: '100',
                uri: 'http://localhost:3000'
            });
            await inputHandler.parseP('\x1b]8;;\x07');
            chai_1.assert.strictEqual(inputHandler.curAttrData.extended.urlId, 0);
        });
