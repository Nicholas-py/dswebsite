...
class CoreTerminal extends lifecycle_1.Disposable {
    get onScroll() {
        if (!this._onScrollApi) {
            this._onScrollApi = this._register(new event_1.Emitter());
    ...
    constructor(options) {
        ...
        this.optionsService = this._register(new OptionsService_1.OptionsService(options));
        this._instantiationService.setService(Services_1.IOptionsService, this.optionsService);
        this._bufferService = this._register(this._instantiationService.createInstance(BufferService_1.BufferService));
        this._instantiationService.setService(Services_1.IBufferService, this._bufferService);
        this._logService = this._register(this._instantiationService.createInstance(LogService_1.LogService));
        this._instantiationService.setService(Services_1.ILogService, this._logService);
        this.coreService = this._register(this._instantiationService.createInstance(CoreService_1.CoreService));
        this._instantiationService.setService(Services_1.ICoreService, this.coreService);
        this.coreMouseService = this._register(this._instantiationService.createInstance(CoreMouseService_1.CoreMouseService));
        this._instantiationService.setService(Services_1.ICoreMouseService, this.coreMouseService);
        this.unicodeService = this._register(this._instantiationService.createInstance(UnicodeService_1.UnicodeService));
        ...
        this._inputHandler = this._register(new InputHandler_1.InputHandler(this._bufferService, this._charsetService, this.coreService, this._logService, this.optionsService, this._oscLinkService, this.coreMouseService, this.unicodeService));
        this._register(event_1.Event.forward(this._inputHandler.onLineFeed, this._onLineFeed));
        this._register(this._inputHandler);
        this._register(event_1.Event.forward(this._bufferService.onResize, this._onResize));
        this._register(event_1.Event.forward(this.coreService.onData, this._onData));
        this._register(event_1.Event.forward(this.coreService.onBinary, this._onBinary));
        ...
        this._writeBuffer = this._register(new WriteBuffer_1.WriteBuffer((data, promiseResult) => this._inputHandler.parse(data, promiseResult)));
        this._register(event_1.Event.forward(this._writeBuffer.onWriteParsed, this._onWriteParsed));
    }
    write(data, callback) {
    ...
    _enableWindowsWrappingHeuristics() {
        if (!this._windowsWrappingHeuristics.value) {
            ...
            this._windowsWrappingHeuristics.value = (0, lifecycle_1.toDisposable)(() => {
