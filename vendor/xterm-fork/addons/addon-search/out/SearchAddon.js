...
class SearchAddon extends lifecycle_1.Disposable {
    constructor(options) {
        super();
        this._highlightedLines = new Set();
        this._highlightDecorations = [];
        this._selectedDecoration = this._register(new lifecycle_1.MutableDisposable());
        this._linesCacheTimeoutId = 0;
        this._linesCacheDisposables = new lifecycle_1.MutableDisposable();
        this._onDidChangeResults = this._register(new event_1.Emitter());
    ...
    activate(terminal) {
        ...
        this._register((0, lifecycle_1.toDisposable)(() => this.clearDecorations()));
    }
    _updateMatches() {
    ...
    clearDecorations(retainCachedSearchTerm) {
        ...
        (0, lifecycle_1.dispose)(this._highlightDecorations);
        this._highlightDecorations = [];
    ...
    _initLinesCache() {
        ...
        if (!this._linesCache) {
            ...
            this._linesCacheDisposables.value = (0, lifecycle_1.combinedDisposable)(terminal.onLineFeed(() => this._destroyLinesCache()), terminal.onCursorMove(() => this._destroyLinesCache()), terminal.onResize(() => this._destroyLinesCache()));
        }
        ...
        if (options) {
            ...
            if (marker) {
                ...
                if (decoration) {
                    ...
                    disposables.push(decoration.onDispose(() => (0, lifecycle_1.dispose)(disposables)));
    ...
    _createResultDecoration(result, options) {
        ...
        if (findResultDecoration) {
            ...
            disposables.push(findResultDecoration.onDispose(() => (0, lifecycle_1.dispose)(disposables)));
        }
