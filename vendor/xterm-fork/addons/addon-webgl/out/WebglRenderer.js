...
const ShimRenderer_1 = require("./ShimRenderer");
...
class WebglRenderer extends lifecycle_1.Disposable {
    constructor(_terminal, _characterJoinerService, _charSizeService, _coreBrowserService, _coreService, _decorationService, _optionsService, _themeService, preserveDrawingBuffer) {
        ...
        this._cursorBlinkStateManager = new lifecycle_1.MutableDisposable();
        this._charAtlasDisposable = this._register(new lifecycle_1.MutableDisposable());
        this._observerDisposable = this._register(new lifecycle_1.MutableDisposable());
        this._model = new RenderModel_1.RenderModel();
        this._workCell = new CellData_1.CellData();
        this._workCell2 = new CellData_1.CellData();
        this._rectangleRenderer = this._register(new lifecycle_1.MutableDisposable());
        this._glyphRenderer = this._register(new lifecycle_1.MutableDisposable());
        this._shimRenderer = this._register(new lifecycle_1.MutableDisposable());
        ...
        this._onRequestRedraw = this._register(new event_1.Emitter());
        ...
        this._register((0, dom_1.addDisposableListener)(this._canvas, 'webglcontextlost', (e) => {
        ...
        this._register((0, dom_1.addDisposableListener)(this._canvas, 'webglcontextrestored', (e) => {
    ...
    _initializeWebGLState() {
        ...
        this._shimRenderer.value = new ShimRenderer_1.ShimRenderer(this._terminal, this._gl, this.dimensions);
    ...
    _refreshCharAtlas() {
        ...
        if (this._charAtlas !== atlas) {
            ...
            this._charAtlasDisposable.value = (0, lifecycle_1.combinedDisposable)(event_1.Event.forward(atlas.onAddTextureAtlasCanvas, this._onAddTextureAtlasCanvas), event_1.Event.forward(atlas.onRemoveTextureAtlasCanvas, this._onRemoveTextureAtlasCanvas));
        }
