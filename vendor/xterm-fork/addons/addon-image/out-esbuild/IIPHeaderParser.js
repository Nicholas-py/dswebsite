...
var IIPHeaderParser_exports = {};
__export(IIPHeaderParser_exports, {
  HeaderParser: () => HeaderParser,
  HeaderState: () => HeaderState
});
module.exports = __toCommonJS(IIPHeaderParser_exports);
/**
 * Copyright (c) 2023 The xterm.js authors. All rights reserved.
 * @license MIT
 */
var HeaderState = /* @__PURE__ */ ((HeaderState2) => {
  HeaderState2[HeaderState2["START"] = 0] = "START";
  HeaderState2[HeaderState2["ABORT"] = 1] = "ABORT";
  HeaderState2[HeaderState2["KEY"] = 2] = "KEY";
  HeaderState2[HeaderState2["VALUE"] = 3] = "VALUE";
  HeaderState2[HeaderState2["END"] = 4] = "END";
  return HeaderState2;
})(HeaderState || {});
function toStr(data) {
  let s = "";
...
class HeaderParser {
  ...
  parse(data, start, end) {
    ...
    if (state === 0 /* START */ && pos > 6) return -1;
